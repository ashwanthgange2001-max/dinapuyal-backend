...
const RSS_FEEDS = {
    ...
    business: {
        url: 'https://www.webdunia.com/rss/business-news-1210107.xml',
        categorySlug: 'business',
        source: 'Webdunia'
    },
    technology: {
        url: 'https://www.webdunia.com/rss/world-technology-news-1210106.xml',
        categorySlug: 'technology',
        source: 'Webdunia'
    },
    health: {
        url: 'https://www.webdunia.com/rss/health-tips-1210111.xml',
        categorySlug: 'health',
        source: 'Webdunia'
    },
    spirituality: {
        url: 'https://www.webdunia.com/rss/religion-astrology-1210108.xml',
...
// =========================================
// HELPER: TRANSLATE TEXT TO TAMIL
// =========================================
                ...
                if (feedConfig.translate) {
                    try {
                        ...
                        const [translatedTitle, translatedDesc] = await Promise.all([
                            ...
                            translateText(item.description || item.title)
                        ]);
